    ...
    return (
        <div className="main-container">
            <div className="row checkout">
                {displayItem4 ? (
                    <>
                        <div className="col-5 cart" >
                            <h2>Cart Summary</h2>
                            <Button variant="outlined" sx={{ bgcolor: 'orange', color: 'white', marginBottom: '1rem' }} onClick={handleRemove4}>EmptyCart</Button> {/* remove button with orange color */}
                            {displayItem ? (
                                <>
                                    ...
                                    <div className="item-box">
                                        <div className="row summary">
                                            ...
                                            <div className="col-4 buttons">
                                                <Button variant="outlined" sx={{ bgcolor: 'orange', color: 'white', marginBottom: '1rem' }} onClick={handleRemove}>Remove</Button> {/* remove button with orange color */}
                                ...
                                <>
                                    ...
                                    <div className="item-box">
                                        <div className="row summary">
                                            ...
                                            <div className="col-4 buttons">
                                                <Button variant="outlined" sx={{ bgcolor: 'orange', color: 'white', marginBottom: '1rem' }} onClick={handleRemove1}>Remove</Button> {/* remove button with orange color */}
                                                <div className="quantity">
                                ...
                                <>
                                    ...
                                    <div className="item-box">
                                        <div className="row summary">
                                            ...
                                            <div className="col-4 buttons">
                                                <Button variant="outlined" sx={{ bgcolor: 'orange', color: 'white', marginBottom: '1rem' }} onClick={handleRemove2}>Remove</Button> {/* remove button with orange color */}
                                                <div className="quantity">
                ...
                <CheckOut />
                <Button variant="contained" color="primary" onClick={() => setShowContent(false)} style={{ marginLeft: '10rem' }}>Back to Cart</Button>
            </div>
        </div>
        </div >
    )
